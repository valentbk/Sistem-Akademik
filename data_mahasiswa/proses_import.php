...
if (isset($_POST['btn-import'])) { // cek button ketika di tekan
    ...
    $query_cek = mysqli_query($db,"SELECT * FROM tbl_mahasiswa WHERE nim = '$nim' OR nama ='$nama' OR kontak = '$kontak' OR email = '$email'") or die(mysqli_error($db));
    // ambil jumlah data
    ...
    if($rv == 0) {
       ...
       $queri_simpan = mysqli_query($db,"INSERT INTO tbl_mahasiswa VALUES ('$nim','$nama','$kontak','$email','$kelamin', null)") or die(mysqli_error($db));
