        ...
        <div class="card">
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php 
                    $query_kelas_matkul = mysqli_query($db,"SELECT * FROM tbl_kelas_matkul")  or die(mysqli_error($db));
                    ...
                    while ($data =mysqli_fetch_array($query_kelas_matkul)) {
                        ...
                        <td>
                          ...
                          <a name= "btn-hapus" class="btn btn-sm  btn-danger" href="proses_hapus.php?id=<?= $id_kelas ?>" onclick="return confirm('apakah kamu yakin akan menghapus data ini?')"><i class="fas fa-trash" ></i></a>
...
include '../script.php'; 
 ...
 <script>
  $('#modal-edit').on('show.bs.modal' , function(e){
    ...
    $(e.currentTarget).find('select[name="id"]').val(id);
